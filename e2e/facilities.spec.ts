...
test.describe('Facilities Booking', () => {
  ...
  test('should display facilities list', async ({ page }) => {
    ...
    await page.waitForURL(/\/resident\/facilities/, { timeout: 60000, waitUntil: 'domcontentloaded' })
  ...
  test('should show user bookings', async ({ page }) => {
    ...
    await page.waitForURL(/\/resident\/bookings/, { timeout: 60000, waitUntil: 'domcontentloaded' })
    await page.waitForLoadState('networkidle')
...
test.describe('Admin Facility Management', () => {
  ...
  test('should display facilities management page', async ({ page }) => {
    ...
    await page.waitForURL(/\/admin\/facilities/, { timeout: 60000, waitUntil: 'domcontentloaded' })
    await page.waitForLoadState('networkidle')
  ...
  test('should manage bookings', async ({ page }) => {
    ...
    await page.waitForURL(/\/admin\/bookings/, { timeout: 60000, waitUntil: 'domcontentloaded' })
    await page.waitForLoadState('networkidle')
